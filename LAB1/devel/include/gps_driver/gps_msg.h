...
struct gps_msg_
{
  ...
  _zone_type zone;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _zone_letter_type;
...
struct MD5Sum< ::gps_driver::gps_msg_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x580f849d52a91f0eULL;
  static const uint64_t static_value2 = 0x46ed47841b1b5c11ULL;
};
...
struct Printer< ::gps_driver::gps_msg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::gps_driver::gps_msg_<ContainerAllocator>& v)
  {
    ...
    s << indent << "zone_letter: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.zone_letter);
  }
};
